public class mainCliente {
    public static void main(String[] args) {
        ...
        Cliente.PessoaFisica pF = new Cliente.PessoaFisica("João", "Rua A", "12345678900", 30, 'M');

        Cliente.PessoaJuridica pJ = new Cliente.PessoaJuridica("JMontadon", "Avenida A", "Ensino e Tecnologia", "12345678911", 1);
